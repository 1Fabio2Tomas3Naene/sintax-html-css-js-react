...
export default function Top(props){
    return(
        <div className={props.standardModeLightMode ? styles.darkMode : styles.lightMode}>
            <header className={styles.header} id="idSectionTopLinks">
            ...
            <nav className={styles.navList}>
                ...
                <li className={styles.listItem}><Link href="/#idSintaxNextJs" className={styles.listAnchor}>next.js</Link></li>
                <li className={styles.listItem}><Link href="/#idSintaxNodeJs" className={styles.listAnchor}>node.js</Link></li>
                <li className={styles.listItem}><Link href="/#idSintaxGit" className={styles.listAnchor}>git</Link></li>
            </nav>
